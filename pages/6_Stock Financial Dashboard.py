...
class Company:
    def __init__(self, ticker):
        ...
        self.market_cap = '${:.2f}'.format(self.market_cap)
    ...
    try:        
        ...
        with col2:
            with st.expander('Profit margins (as of {})'.format(company.year_end), expanded=1):
                ...
                #profit_margin ={'Value':['{:.2f}%'.format(company.gross_margin), '{:.2f}%'.format(company.operating_margin), '{:.2f}%'.format(company.net_margin)]}
